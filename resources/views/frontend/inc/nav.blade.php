            ...
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40"><br>
                           <center> <i><span style="color:red">PC</span>Store</i></center>
                        @else
                ...
                <div class="d-lg-none ml-auto mr-0">
                    <a class="p-2 d-block text-reset" href="javascript:void(0);" data-toggle="class-toggle" data-target=".front-header-search">
                       serach  <i class="las la-search la-flip-horizontal la-2x"></i>
                    </a>
                </div>
                        ...
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="input-group">
                                    <input type="text" class="border-0 border-lg form-control" id="search" name="q" placeholder="{{translate('Search for product')}}" autocomplete="off">
...
<div class="btn-group">
  <button class="btn btn-secondary btn-sm" type="button">
    <span style="margin-left:30px;font-size:12pt">Select Catygories </span>
  </button>
