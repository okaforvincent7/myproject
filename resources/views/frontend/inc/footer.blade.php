        ...
        <div class="row">
                   ...
                   <h4 class="fs-13 text-uppercase fw-600 border-bottom border-gray-900 pb-2 mb-4">
                    ...
                    <ul class="list-unstyled">
                        @if (Auth::check())
                                ...
                                <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('logout') }}" style="border-bottom:2px solid white;margin-right:4px">
                                    {{ translate('Logout') }}
                                </a><br>
                           
                        @else
                            
                                <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('user.login') }}"style="border-bottom:2px solid white;margin-right:4px">
                                    {{ translate('Login') }}
                                </a><br>
                            
                        @endif
                        
                          <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('supportpolicy') }}"style="border-bottom:2px solid white;margin-right:4px">
                                    About Us
                                </a><br>
                        
                        
                        
                            <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('purchase_history.index') }}"style="border-bottom:2px solid white;margin-right:4px">
                                {{ translate('Order History') }}
                            </a><br>
                        
                            <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('wishlists.index') }}"style="border-bottom:2px solid white;margin-right:4px">
                                {{ translate('My Wishlist') }}
                            </a><br>
                        
                            <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('orders.track') }}" style="border-bottom:2px solid white;margin-right:4px">
                                {{ translate('Track Order') }}
                            </a></br>
                       
                        @if (\App\Addon::where('unique_identifier', 'affiliate_system')->first() != null && \App\Addon::where('unique_identifier', 'affiliate_system')->first()->activated)
                           
                                <a class="opacity-50 hov-opacity-100 text-light" href="{{ route('affiliate.apply') }}" style="border-bottom:2px solid white;margin-right:4px">{{ translate('Be an affiliate partner')}}</a>
            ...
            <div class="col-md-4 col-lg-2">
                <div class="text-center text-md-left mt-4">
                   <h4> What type  of Laptop do you need let us Discourse</h4>
                   <a  href=""> 
                   
                    <a href="https://api.whatsapp.com/send?phone=+2348061692943&text=i want to buy laptop from vintech pc store">
                          
                   <img src="https://vintechpcstore.com/whats.png" style="width:100%"></a>
                </div>
